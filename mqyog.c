...
/* If you declare any globals in php_mqyog.h uncomment this:
...
/* {{{ proto string confirm_mqyog_compiled(string arg)
   Return a string to confirm that the module is compiled in */
PHP_FUNCTION(confirm_mqyog_compiled)
{
	char *arg = NULL;
	int arg_len, len;
	char *strg;
	...
	len = spprintf(&strg, 0, "Congratulations! You have successfully modified ext/%.78s/config.m4. Module %.78s is now compiled into PHP.", "mqyog", arg);
...
static void php_mqyog_init_globals(zend_mqyog_globals *mqyog_globals)
{
	mqyog_globals->global_value = 0;
	mqyog_globals->global_string = NULL;
}
*/
/* }}} */
 ...
 */
const zend_function_entry mqyog_functions[] = {
	PHP_FE(confirm_mqyog_compiled,	NULL)		/* For testing, remove later. */
	PHP_FE_END	/* Must be the last line in mqyog_functions[] */
};
/* }}} */
